...
namespace CR_FREE_TYM
{
	...
	public partial class ISODataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertView_ReportRDFType(View_ReportRDFType instance);
    partial void UpdateView_ReportRDFType(View_ReportRDFType instance);
    partial void DeleteView_ReportRDFType(View_ReportRDFType instance);
    #endregion
		
		public ISODataContext() : 
				base(global::CR_FREE_TYM.Properties.Settings.Default.WolfApproveCore_QAR2ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public ISODataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ISODataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ISODataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ISODataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<View_ReportRDFType> View_ReportRDFTypes
		{
			get
			{
				return this.GetTable<View_ReportRDFType>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.View_ReportRDFTypes")]
	public partial class View_ReportRDFType : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _รหัสเอกสาร;
		
		private string _ชื่อเอกสาร;
		
		private string _ประเภทเอกสาร;
		
		private int _แก้ไขครั้งที่;
		
		private System.DateTime _วันที่ต้องการประกาศใช้;
		
		private string _ชื่อฝ่าย_กลุ่มงาน_แผนก;
		
		private string _ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน;
		
		private System.DateTime _วันที่ต้องทบทวนเอกสาร;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnMemo_MemoIdChanging(int value);
    partial void OnMemo_MemoIdChanged();
    partial void OnรหัสเอกสารChanging(string value);
    partial void OnรหัสเอกสารChanged();
    partial void Onชื่อเอกสารChanging(string value);
    partial void Onชื่อเอกสารChanged();
    partial void OnประเภทเอกสารChanging(string value);
    partial void OnประเภทเอกสารChanged();
    partial void Onแก้ไขครั้งที่Changing(int value);
    partial void Onแก้ไขครั้งที่Changed();
    partial void Onวันที่ต้องการประกาศใช้Changing(System.DateTime value);
    partial void Onวันที่ต้องการประกาศใช้Changed();
    partial void Onชื่อฝ่าย_กลุ่มงาน_แผนกChanging(string value);
    partial void Onชื่อฝ่าย_กลุ่มงาน_แผนกChanged();
    partial void Onระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐานChanging(string value);
    partial void Onระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐานChanged();
    partial void Onวันที่ต้องทบทวนเอกสารChanging(System.DateTime value);
    partial void Onวันที่ต้องทบทวนเอกสารChanged();
    #endregion
		
		public View_ReportRDFType()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Memo_MemoId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Memo_MemoId
		{
			...
			set
			{
				...
				{
					this.OnMemo_MemoIdChanging(value);
					this.SendPropertyChanging();
					this._Memo_MemoId = value;
					this.SendPropertyChanged("Memo_MemoId");
					this.OnMemo_MemoIdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_รหัสเอกสาร", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string รหัสเอกสาร
		{
			get
			{
				return this._รหัสเอกสาร;
			}
			set
			{
				if ((this._รหัสเอกสาร != value))
				{
					this.OnรหัสเอกสารChanging(value);
					this.SendPropertyChanging();
					this._รหัสเอกสาร = value;
					this.SendPropertyChanged("รหัสเอกสาร");
					this.OnรหัสเอกสารChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ชื่อเอกสาร", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string ชื่อเอกสาร
		{
			get
			{
				return this._ชื่อเอกสาร;
			}
			set
			{
				if ((this._ชื่อเอกสาร != value))
				{
					this.Onชื่อเอกสารChanging(value);
					this.SendPropertyChanging();
					this._ชื่อเอกสาร = value;
					this.SendPropertyChanged("ชื่อเอกสาร");
					this.Onชื่อเอกสารChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ประเภทเอกสาร", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string ประเภทเอกสาร
		{
			get
			{
				return this._ประเภทเอกสาร;
			}
			set
			{
				if ((this._ประเภทเอกสาร != value))
				{
					this.OnประเภทเอกสารChanging(value);
					this.SendPropertyChanging();
					this._ประเภทเอกสาร = value;
					this.SendPropertyChanged("ประเภทเอกสาร");
					this.OnประเภทเอกสารChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_แก้ไขครั้งที่", DbType="Int NOT NULL")]
		public int แก้ไขครั้งที่
		{
			get
			{
				return this._แก้ไขครั้งที่;
			}
			set
			{
				if ((this._แก้ไขครั้งที่ != value))
				{
					this.Onแก้ไขครั้งที่Changing(value);
					this.SendPropertyChanging();
					this._แก้ไขครั้งที่ = value;
					this.SendPropertyChanged("แก้ไขครั้งที่");
					this.Onแก้ไขครั้งที่Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_วันที่ต้องการประกาศใช้", DbType="Date NOT NULL")]
		public System.DateTime วันที่ต้องการประกาศใช้
		{
			get
			{
				return this._วันที่ต้องการประกาศใช้;
			}
			set
			{
				if ((this._วันที่ต้องการประกาศใช้ != value))
				{
					this.Onวันที่ต้องการประกาศใช้Changing(value);
					this.SendPropertyChanging();
					this._วันที่ต้องการประกาศใช้ = value;
					this.SendPropertyChanged("วันที่ต้องการประกาศใช้");
					this.Onวันที่ต้องการประกาศใช้Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[ชื่อฝ่าย/กลุ่มงาน/แผนก]", Storage="_ชื่อฝ่าย_กลุ่มงาน_แผนก", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string ชื่อฝ่าย_กลุ่มงาน_แผนก
		{
			get
			{
				return this._ชื่อฝ่าย_กลุ่มงาน_แผนก;
			}
			set
			{
				if ((this._ชื่อฝ่าย_กลุ่มงาน_แผนก != value))
				{
					this.Onชื่อฝ่าย_กลุ่มงาน_แผนกChanging(value);
					this.SendPropertyChanging();
					this._ชื่อฝ่าย_กลุ่มงาน_แผนก = value;
					this.SendPropertyChanged("ชื่อฝ่าย_กลุ่มงาน_แผนก");
					this.Onชื่อฝ่าย_กลุ่มงาน_แผนกChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[ระบบ / มาตรฐาน และ ข้อกำหนดที่เกี่ยวข้อง|ระบบ / มาตรฐาน]", Storage="_ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน
		{
			get
			{
				return this._ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน;
			}
			set
			{
				if ((this._ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน != value))
				{
					this.Onระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐานChanging(value);
					this.SendPropertyChanging();
					this._ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน = value;
					this.SendPropertyChanged("ระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐาน");
					this.Onระบบ___มาตรฐาน_และ_ข้อกำหนดที่เกี่ยวข้อง_ระบบ___มาตรฐานChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_วันที่ต้องทบทวนเอกสาร", DbType="Date NOT NULL")]
		public System.DateTime วันที่ต้องทบทวนเอกสาร
		{
			get
			{
				return this._วันที่ต้องทบทวนเอกสาร;
			}
			set
			{
				if ((this._วันที่ต้องทบทวนเอกสาร != value))
				{
					this.Onวันที่ต้องทบทวนเอกสารChanging(value);
					this.SendPropertyChanging();
					this._วันที่ต้องทบทวนเอกสาร = value;
					this.SendPropertyChanged("วันที่ต้องทบทวนเอกสาร");
					this.Onวันที่ต้องทบทวนเอกสารChanged();
				}
			}
		}
